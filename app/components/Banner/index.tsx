...
const Banner = () => {
  return (
    <div
        style={{
                  background: "linear-gradient(to bottom, #082f49 0%, #0369a1 60%, #f8fafc 100%)"
         }}
      ...
      <div className="mx-auto relative min-h-[100vh] flex flex-col justify-center items-center">
        <div className="text-center z-[1]">
          <GradualSpacing
            ...
            text="We bring innovation and freshness"
          />
          <GradualSpacing
            className="text-2xl sm:text-5xl lg:text-7xl drop-shadow-lg text-white font-semibold md:4px lh-96"
        ...
        <div className="text-center z-[1] mt-10">
          <BlurFade>
            <p className="text-md leading-8 text-white drop-shadow-lg font-medium text-opacity-90">
              Supdeco Junior Entreprise accompagne entreprises, entrepreneurs et organisations à travers l'expertise et l'engagement
               des étudiants du Groupe Supdeco Dakar
