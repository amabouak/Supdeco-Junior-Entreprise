      ...
      <div className="mx-auto px-5 sm:px-24 py-20">
        ...
        <BlurFade inView={true}>
          <div className="section-title text-center relative pb-5 mb-10">
            ...
            <h1 className="text-2xl md:text-4xl mb-0">Contactez-Nous</h1>
          </div>
          <div className="mx-auto max-w-2xl lg:max-w-7xl bg-gradient-to-r from-azure-950 to-azure-500 rounded-3xl">
            <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
                ...
                <div className="h-full w-full p-5">
                  <div className="h-full w-full rounded-2xl overflow-hidden">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=supdeco+(Supdeco%20Junior%20Entreprise)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                    ></iframe>
                  </div>
                </div>
              </div>
              ...
              <div className="p-10 flex flex-col justify-center">
                ...
                <h4 className="text-base font-normal mb-7 text-white">
                  Nous sommes là pour vous aider. Si vous avez des questions ou avez
                ...
                >
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <MdOutlineBusinessCenter className="text-azure-700" />
                    <input
                      type="text"
                      name="company"
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineUser className="text-azure-700" />
                    <input
                      type="text"
                      name="name"
                      placeholder="Nom"
                  ...
                  <div className="flex items-center gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineMail className="text-azure-700" />
                    <input
                      type="email"
                      name="email"
                      placeholder="Email"
                  ...
                  <div className="flex items-start gap-4 bg-white rounded-2xl px-4 py-2">
                    <AiOutlineMessage className="text-azure-700 mt-1" />
                    <textarea
                      name="message"
                      placeholder="Message"
                      className="w-full bg-transparent outline-none"
                  ...
                  {sending ? (
                    ...
                    >
                      Envoyer le Message <FiSend className="inline-block ml-2" />
                    </button>
                  )}
                  {success && (
